...
export interface IERC6956AttestationLimitedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "anchorByToken"
  ...
  encodeFunctionData(
    functionFragment: "attestationLimit",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "attestationLimitPolicy",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "attestationUsagesLeft",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export namespace AttestationLimitReachedEvent {
  export type InputTuple = [
    anchor: BytesLike,
    tokenId: BigNumberish,
    transferLimit: BigNumberish
  ];
  export type OutputTuple = [
    anchor: string,
    tokenId: bigint,
...
export namespace AttestationLimitUpdateEvent {
  export type InputTuple = [
    anchor: BytesLike,
    tokenId: BigNumberish,
    transferLimit: BigNumberish,
...
export namespace GlobalAttestationLimitUpdateEvent {
  export type InputTuple = [
    transferLimit: BigNumberish,
    updatedBy: AddressLike
  ];
  export type OutputTuple = [transferLimit: bigint, updatedBy: string];
  export interface OutputObject {
    transferLimit: bigint;
    updatedBy: string;
  }
...
export interface IERC6956AttestationLimited extends BaseContract {
  connect(runner?: ContractRunner | null): IERC6956AttestationLimited;
  waitForDeployment(): Promise<this>;

  interface: IERC6956AttestationLimitedInterface;
  ...
  attestationLimit: TypedContractMethod<[anchor: BytesLike], [bigint], "view">;

  attestationLimitPolicy: TypedContractMethod<[], [bigint], "view">;

  attestationUsagesLeft: TypedContractMethod<
    [anchor: BytesLike],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "attestationLimit"
  ): TypedContractMethod<[anchor: BytesLike], [bigint], "view">;
  getFunction(
    nameOrSignature: "attestationLimitPolicy"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "attestationUsagesLeft"
  ): TypedContractMethod<[anchor: BytesLike], [bigint], "view">;
  getFunction(
  ...
  >;
  getEvent(
    key: "AttestationLimitReached"
  ): TypedContractEvent<
    AttestationLimitReachedEvent.InputTuple,
    AttestationLimitReachedEvent.OutputTuple,
    AttestationLimitReachedEvent.OutputObject
  >;
  getEvent(
    key: "AttestationLimitUpdate"
  ): TypedContractEvent<
    AttestationLimitUpdateEvent.InputTuple,
    AttestationLimitUpdateEvent.OutputTuple,
    AttestationLimitUpdateEvent.OutputObject
  >;
  getEvent(
    key: "AttestationUse"
  ): TypedContractEvent<
  ...
  >;
  getEvent(
    key: "GlobalAttestationLimitUpdate"
  ): TypedContractEvent<
    GlobalAttestationLimitUpdateEvent.InputTuple,
    GlobalAttestationLimitUpdateEvent.OutputTuple,
    GlobalAttestationLimitUpdateEvent.OutputObject
  >;
  getEvent(
    key: "OracleUpdate"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "AttestationLimitReached(bytes32,uint256,uint256)": TypedContractEvent<
      AttestationLimitReachedEvent.InputTuple,
      AttestationLimitReachedEvent.OutputTuple,
      AttestationLimitReachedEvent.OutputObject
    >;
    AttestationLimitReached: TypedContractEvent<
      AttestationLimitReachedEvent.InputTuple,
      AttestationLimitReachedEvent.OutputTuple,
      AttestationLimitReachedEvent.OutputObject
    >;

    "AttestationLimitUpdate(bytes32,uint256,uint256,address)": TypedContractEvent<
      AttestationLimitUpdateEvent.InputTuple,
      AttestationLimitUpdateEvent.OutputTuple,
      AttestationLimitUpdateEvent.OutputObject
    >;
    AttestationLimitUpdate: TypedContractEvent<
      AttestationLimitUpdateEvent.InputTuple,
      AttestationLimitUpdateEvent.OutputTuple,
      AttestationLimitUpdateEvent.OutputObject
    >;
    ...
    "GlobalAttestationLimitUpdate(uint256,address)": TypedContractEvent<
      GlobalAttestationLimitUpdateEvent.InputTuple,
      GlobalAttestationLimitUpdateEvent.OutputTuple,
      GlobalAttestationLimitUpdateEvent.OutputObject
    >;
    GlobalAttestationLimitUpdate: TypedContractEvent<
      GlobalAttestationLimitUpdateEvent.InputTuple,
      GlobalAttestationLimitUpdateEvent.OutputTuple,
      GlobalAttestationLimitUpdateEvent.OutputObject
    >;
