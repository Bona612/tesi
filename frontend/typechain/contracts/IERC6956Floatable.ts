...
export interface IERC6956FloatableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "anchorByToken"
...
export interface IERC6956Floatable extends BaseContract {
  connect(runner?: ContractRunner | null): IERC6956Floatable;
  waitForDeployment(): Promise<this>;

  interface: IERC6956FloatableInterface;
  ...
  float: TypedContractMethod<
    [anchor: BytesLike, newState: BigNumberish],
    [void],
    "nonpayable"
  >;
