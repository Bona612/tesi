...
export interface IERC6956Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "anchorByToken"
...
export interface IERC6956 extends BaseContract {
  connect(runner?: ContractRunner | null): IERC6956;
  waitForDeployment(): Promise<this>;

  interface: IERC6956Interface;
